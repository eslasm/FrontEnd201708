...
namespace Teine {
    ...
    */
    ...
    massiiv3.find((element) => {return element.startsWith('ba'));
    ...
    // recude RecudeRight
    let numbrid2 = [[1,2][4,7][8,9]];
    numbrid2.reduce((a, b) => a.concat(b));
...
let elements1 = document.querySelectorAll('body article'); // css queryde abil
// $('body article');
...
elements.item(0).onclick = (event) => {alert('Hello');};
