...
namespace Teine {
    ...
    */
    ...
    /* Massiivid */
    const massiiv = ['õun', 'pirn', 'banaan', 'sidrun'];
    ...
    // massiiv3.splice(2, 3); // eemaldab elemendid lisatakse teise massiivi
    ...
    massiiv.lastIndexOf('sidrun');
    massiiv3.find((element) => element.startsWith('ba'));
    ...
    console.log(numbrid);
    massiiv3.reverse(); // pöörab olemas oleva massiivi pahupidi

    // reduce reduceRight
    const astmesNumbrid2 = [[1, 2], [4, 7], [8, 9]];
    let numbrid2 = astmesNumbrid2.reduceRight((a, b) => a.concat(b)); // järjestus tagurpidi
    ...
    // values and entries sarnaselt arrayle
     // for (const [key, value] of Array.form(map))
    ...
    let elements1 = document.getElementsByName('article');
