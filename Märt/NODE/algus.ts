...
namespace Algus {
    ...
    // soovituslik määrata tüübi kontroll
    ...
    const isikutootlus = (isik: Isik) => {
        // isik.perenimi = 'Tamm';
        console.log(`Nimi:${isik.eesnimi} ${isik.perenimi} ${isik.vanus}`);
    ...
    class Koer extends Loom {
        private kondOtsingul = false;
        constructor() {
            super('koer'); // vanema konstruktor
        }
        public viskaKont() {
            this.kondOtsingul = true;
        }
            public kasKontiOtsib() {
                console.log(this.kondOtsingul);
            }
    }
